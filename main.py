...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","SHRISTISPAMUPDATE")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","@I_am_pure_single")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","SHRISTISPAMXMUSIC")
BOT_NAME = os.environ.get("BOT_NAME","SHRISTI")
...
SOURCE = 'https://github.com/ShrutiMusic1/BRANDEDCHATBOT'
x=["❤️","🎉","✨","🪸","🎉","🎈","💸"]
g=choice(x)
async def is_admins(chat_id: int):
    return [
        member.user.id
        async for member in SHRISTISPAMXMUSIC.get_chat_members(
...
@Shristi_spamxmusic.on_message(filters.incoming & filters.private, group=-1)
...
@Shristi_spamxmusic.on_message(filters.command(["start",f"start@{BOT_USERNAME}"]))
async def restart(client, m: Message):
        accha = await m.reply_text(
                        text = f"{g}")
        await asyncio.sleep(1)
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉 @SHRISTISPAMXMUSIC , @SHRISTISPAMUPDATE 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @I_am_pure_single ❤️")
        await asyncio.sleep(0.5)
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉 @SHRISTISPAMXMUSIC , @SHRISTISPAMUPDATE 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @I_am_pure_single ❤️")
        await asyncio.sleep(0.5)
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉  @SHRISTISPAMXMUSIC , @SHRISTISPAMUPDATE 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @I_am_pure_single ❤️")
        await asyncio.sleep(0.5)
        await accha.delete("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉  @SHRISTISPAMXMUSIC , @SHRISTISPAMUPDATE 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @I_am_pure_single ❤️")
...
@Shristi_spamxmusic.on_callback_query()
...
@Shristi_spamxmusic.on_message(filters.command(["help", f"help@{BOT_USERNAME}"], prefixes=["","+", ".", "/", "-", "?", "$"]))
async def restart(client, message):
    hmm = await message.reply_photo(START_IMG,
                             caption= HELP_READ,
                        reply_markup= InlineKeyboardMarkup(HELP_BACK),
       )
@Shristi_spamxmusic.on_message(filters.command(['source', 'repo']))
async def source(bot, m):
    await m.reply_photo(START_IMG, caption=SOURCE_TEXT, reply_markup=SOURCE_BUTTONS, reply_to_message_id=m.id)
#  alive
@Shristi_spamxmusic.on_message(filters.command(["ping","alive"], prefixes=["","+", "/", "-", "?", "$", "&","."]))
async def ping(client, message: Message):
        ...
        await message.reply_photo(
                             photo=START_IMG,
                             caption=f"ʜᴇʏ ʙᴀʙʏ!!\n**[{BOT_NAME}](t.me/{BOT_USERNAME})** ɪꜱ ᴀʟɪᴠᴇ 🥀 ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ꜰɪɴᴇ ᴡɪᴛʜ ᴘᴏɴɢ ᴏꜰ \n➥ `{ms}` ms\n\n**ᴍᴀᴅᴇ ᴡɪᴛʜ ❣️ ʙʏ || [SANU](https://t.me/I_am_pure_single)||**",
                             reply_markup=InlineKeyboardMarkup(PNG_BTN),
       )

@Shristi_spamxmusic.on_message(
...
async def vickai(client: Client, message: Message):
   ...
   if not message.reply_to_message:
       ...
       is_vick = vick.find_one({"chat_id": message.chat.id})
       if not is_vick:
           await SHRISTISPAMXMUSIC.send_chat_action(message.chat.id, ChatAction.TYPING)
           K = []  
   ...
   if message.reply_to_message:  
       ...
       vick = vickdb["VickDb"]["Vick"] 
       is_vick = vick.find_one({"chat_id": message.chat.id})    
       getme = await SHRISTISPAMXMUSIC.get_me()
       bot_id = getme.id                             
